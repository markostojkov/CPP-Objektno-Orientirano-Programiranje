...
class AlkoholPercentException
{
    ...
    public:
        AlkoholPercentException(char *message)
        {
...
class RegistrationException
{
    ...
    public:
        RegistrationException(char *message)
        {
            this->message = new char[strlen(message) + 1];
            strcpy(this->message, message);
        }
...
class PaketPijalok
{
    ...
    public:
        static constexpr double masaNaAmbalaza = 0.2;
        static constexpr double gustina = 0.8;
...
class PaketVino : public PaketPijalok, public ImaMasa
{
    ...
    public:
        static constexpr double procentAlkoholKoeficient = 0.9;
            ...
            : PaketPijalok(volumenNaEdenPaket, kolicina)
        {
            try
            {
                ...
                {
                    throw AlkoholPercentException("Pogresno vnesen procent na alkohol!");
                }
    ...
    public:
        ...
        void registriraj(char *registracija)
        {
            if (!isalpha(registracija[0]) || !isalpha(registracija[1]) || 
                ...
                {
                    throw RegistrationException("Pogresno vnesena registracija!");
                }
